 ...
 * @author HoangVanToan
 */
public class V_SuaLop extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("SỬA THÔNG TIN LỚP HỌC");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_SuaLop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
