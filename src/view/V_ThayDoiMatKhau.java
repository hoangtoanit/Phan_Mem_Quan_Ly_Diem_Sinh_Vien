 ...
 * @author PC
 */
public class V_ThayDoiMatKhau extends javax.swing.JFrame {

    /**
     * Creates new form frm_login
     */
    public V_ThayDoiMatKhau() {
        initComponents();//phần thiết kế giao diện form
        setLocationRelativeTo(null);//chỉnh form ra giữa màn hình
        setTitle("Đổi Mật Khẩu");//Đặt tiêu đề cho form
    }
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btThoat, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(60, 60, 60))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_ThayDoiMatKhau.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_ThayDoiMatKhau().setVisible(true);
            }
        });
    }
